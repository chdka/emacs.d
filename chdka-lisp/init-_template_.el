;;; init-_template_.el -*- lexical-binding: t; -*-
...
;;  This is a template for adding a package with use-package notation
...
;;  :straight                             ; use straight.el, and provide a recipe
...
(message "    init-_template_.el - install _template_..")

(use-package _template_
  :disabled                             ; 
  :straight t                           ; 
  :demand                               ; 
  :after
...
(provide 'init-_template_)
;;; init-_template_.el ends here
