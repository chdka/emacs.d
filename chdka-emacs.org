...
#+RESULTS:
: ((fullscreen . maximised) (vertical-scroll-bars . right))
...
#+begin_src emacs-lisp
  (use-package elfeed-org
   ...
   :config
     (elfeed-org)
     (setq rmh-elfeed-org-files (list (expand-file-name "ChriszunNotities/elfeed.org" chdka-emacs--env-emacs-home-org))))
#+end_src
